...
@section('page-title', 'Tutti i Linguaggi')

@section('main-content')
<div class="container mt-4">
    <div class="row">
        <div class="col-6">
            <h2 class="text-primary">Linguaggi</h2>

            <a href="{{ route('admin.types.create') }}" class="btn btn-primary mb-3">Aggiungi Linguaggio <i class="fa-solid fa-plus"></i></a>
